...
let arryNumPriceMonthly = [0,1,2,3];
...
let savingChartDataPriceMonthly = arryNumPriceMonthly.map(num => {
    let savingSumPriceMonthly = parseInt(document.getElementById(`monthly-price${num}`).innerText, 10);
    let savingNamePriceMonthly = document.getElementById(`name${num}`).innerText;
