...
class Canvas {
    ...
    drawBackground() {
        ...
        gradient.addColorStop(0, '#64dfdf');
        gradient.addColorStop(1, '#64dfdf');
    ...
    drawText() {
        ...
        this.ctx.fillText('Energify', this.canvas.width / 2, this.canvas.height / 2 - size / 2);
    }
    ...
    drawMouse() {
        ...
        this.ctx.strokeStyle = this.mouse.mousedown ? '#7400b8' : '#7400b8';
